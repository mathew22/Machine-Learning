function [] = sphericalClusteringUsingPlot( noOfPoints , noOfClusters ,maxItr)
%sphericalClustering( 200 , 4,5)
% no of colors mentioned =5 . So clusters cannot be grater than 5
% Represents the vectors using line  uses plot function )
close all;
